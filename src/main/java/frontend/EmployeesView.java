 ...
 * @author romia
 */
public class EmployeesView extends TableView {
    ...
    {
        super(new String[]{"EmployeesID","Name","Email","Address","Phone Number"});
        StringFormat(Admin_Role.admin.getListOfEmployees(),5);
